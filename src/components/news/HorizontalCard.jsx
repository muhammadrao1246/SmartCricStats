...
function HorizontalCard({ newsData }) {

  if (newsData == null) {
    return <PlaceHolderHorizontalCard />
  }
  ...
  return (
    <Link to={"/news/"+newsData.slug} className="card horizontal-side-card p-2 custom-card">
      <div className="row no-gutters align-items-center">
        <div className="col-sm-4">
          <LazyLoadImage 
            src={newsData.coverImage != null ? newsData.coverImage : PlaceholderImage }
            onError={(e)=>e.target.src = PlaceholderImage}
            className="card-img border rounded horizontal-side-card-image"
            alt="Image"
          />
        </div>
        <div className="col-sm-8">
          <div className="card-body d-flex flex-column justify-content-start">
            <h4 className="card-title horizontal-side-card-title">
            {newsData.title}
            </h4>
            <p className="card-text horizontal-side-card-description">
...
function PlaceHolderHorizontalCard() {
  return (
    <div className="card news-main-card p-2 news-side-card custom-card">
      ...
      <div className="col-sm-4">
          <ShimmerThumbnail 
          height={100}
          className="card-img rounded news-side-card-image horizontal-side-card-image m-0" />
        </div>
        <div className="col-sm-8">
          <div className="card-body d-flex flex-column justify-content-start">
            <ShimmerTitle line={2} gap={10} variant="secondary" 
            className="card-title news-side-card-title horizontal-side-card-title" />
