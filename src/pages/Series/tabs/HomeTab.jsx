...
import { FindSeriesLongName } from "src/utils/utils";


let placeholder_news = [null, null, null, null]
function HomeTab({series, onClick}) {
    ...
    <div className="row">
      <div className="col-lg-12">
        <div className="iq-card iq-card-block iq-card-stretch iq-card-height">
          <div className="iq-card-header d-flex justify-content-between">
            <div className="iq-header-title">
              <h4 className="card-title">
                Latest News About {FindSeriesLongName(series)} & Teams
              </h4>
            </div>
          </div>
          ...
          <ViewMoreAnchor text={"Read All News"} onClick={onClick} link={`?tab=news`}  />
        </div>
      </div>
    </div>
  );
